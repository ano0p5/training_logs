	...
	usi_aff = {
		...
		usi_app.main = function () {
			try {
				...
				usi_app.is_confirmation_page = usi_app.url.match("/receipt") != null;
				...
				usi_app.is_suppressed = !usi_app.is_forced && (usi_app.url.match("cvs.com") == null ||
				...
				if (usi_app.is_confirmation_page && typeof USI_orderID == "undefined") {
					usi_commons.load_script("//www.upsellit.com/active/cvs_pixel.jsp");
				}
